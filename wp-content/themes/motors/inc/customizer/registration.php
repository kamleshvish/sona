...
$topBarSettings["fields"]['top_bar_bg_color'] = array(
    ...
    'type' => 'color',
    'output' => array('background-color' => '#top-bar, .top-bar-wrap, .stm-template-listing #top-bar, body.page-template-home-service-layout #top-bar,
											.stm-template-car_dealer_two.no_margin #wrapper #stm-boats-header #top-bar:after,
											.stm-template-aircrafts:not(.home), .stm-template-aircrafts:not(.stm-inventory-page), .stm-template-aircrafts:not(.single-listings) #wrapper #top-bar, '),
    'transport' => 'postMessage',
    'default' => $default_color
);
